...
#from yt_dlp import YoutubeDL
#
#ydl_opts = {'format': '[height=360]+bestaudio','outtmpl': '/%(title)s.mp4',}
#bestvideo+bestaudio/best
#ydl_opts = {'format': '398+bestaudio','outtmpl': '/%(title)s.mp4',}
"""ydl_opts = {'format': '398++bestaudio/best','outtmpl': '/%(title)s.mp4',}

with YoutubeDL(ydl_opts) as ydl:
    ydl.download(['https://www.youtube.com/watch?v=x17YdTfIVo0'])
...
url= 'https://www.youtube.com/watch?v=7RyVrPY3ZQU'
#download(url);
